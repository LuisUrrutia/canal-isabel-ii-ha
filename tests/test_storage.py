...
from custom_components.canal_de_isabel_ii.billing.storage import (
    CanalTariffProfileStore,
)
from custom_components.canal_de_isabel_ii.consumption.storage import CanalHistoryStore
...
async def test_malformed_history_is_ignored(hass: HomeAssistant) -> None:
    ...
    with patch(
        "custom_components.canal_de_isabel_ii.consumption.storage.Store.async_load",
...
async def test_malformed_tariff_profiles_are_ignored(hass: HomeAssistant) -> None:
    ...
    with patch(
        "custom_components.canal_de_isabel_ii.billing.storage.Store.async_load",
